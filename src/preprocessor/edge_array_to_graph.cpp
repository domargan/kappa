...
void edge_array_to_digraph(Digraph* g,
  ...
  std::cout << "\n-------------------------------------------------------------"
               "----------------------------"
               "\n[START]\t\tPopulating digraph with entries from edge array..."
            << std::endl;
  ...
  while (current_line < end_line) {
    g->add_edge_populate(edge_array[current_line][0],
                         edge_array[current_line][1]);
    ++current_line;
