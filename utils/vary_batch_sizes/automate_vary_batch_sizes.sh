...
KAPPA_PLOT_DATA="vary_batch_sizes.dat"
COMP_PLOT_FILE=$(mktemp gnuplot_computation.pXXX)
COMP_OUT_FILE=computation_vary_batches_plot
UPDATES_PLOT_FILE=$(mktemp updates_gnuplot.pXXX)
UPDATES_OUT_FILE=updates_vary_batches_plot

#### Run scaling experiments and log measurements ####

batch_sizes=(1 1000 10000 100000 1000000)
iters=(1 2 3 4 5)
...
plot \
	...
	"$KAPPA_PLOT_DATA" using 1:5 title '' with linespoint
EOF
...
plot \
	...
	"$KAPPA_PLOT_DATA" using 1:3 title '' with yerrorbars
EOF
